...
// Supports both portal (default) and inline mode for MobileFrame
...
>(({ className, inline, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      'inset-0 z-50 bg-black/80 overflow-hidden',
...
>(({ className, children, inline, container, ...props }, ref) => {
  const content = (
    <>
      <DialogOverlay inline={inline} />
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          inline ? 'absolute' : 'fixed',
          'left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4',
